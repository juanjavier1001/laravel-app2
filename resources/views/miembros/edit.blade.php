                ...
                <div class="row mb-3">
                    ...
                    <div class=" col-lg-6 col-xl-3">
                        ...
                        <input type="email" class="form-control" name="email" id="exampleInputEmail"
                            value="{{ old('email', $miembro->email) }}" required>
                        <small style="color: red">
                            @error('email')
                                {{ $message }}
                            @enderror
                    ...
                    <div class=" col-lg-6 col-xl-3">
                        ...
                        <input type="number" class="form-control" name="telefono" id="exampleInputTelefono"
                            value="{{ old('telefono', $miembro->telefono) }}" required>
                        <small style="color: red">
                            @error('telefono')
                                {{ $message }}
                            @enderror
                ...
                <div class="row mb-4">
                    <div class=" col-lg-6 col-xl-3">
                        ...
                        <input type="date" class="form-control" name="fecha_nacimiento" id="exampleInputNacimiento"
                            value="{{ old('fecha_nacimiento', $miembro->fecha_nacimiento) }}" required>
                        <small style="color: red">
                    ...
                    <div class=" col-lg-6 col-xl-3">
                        ...
                        <input type="text" class="form-control" name="direccion" id="exampleInputDireccion"
                            value="{{ old('direccion', $miembro->direccion) }}" required>
                    ...
                    <div class=" col-lg-6 col-xl-2">
                        ...
                        <output id="list">
                            @if ($miembro->foto == '')
                                <p>no hay foto</p>
                            @else
                                <img src="{{ asset('storage/imagesMiembro/' . $miembro->foto) }}" width="80%"
                                    alt="">
                            @endif
                        </output>
                        <script>
