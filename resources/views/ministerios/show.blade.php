...
@section('content')
    ...
    <div class="col-12 col-lg-9">
        <div class="card card-widget widget-user shadow">
            ...
            <div class="widget-user-image ">
                <img class="img-circle elevation-2 " src="{{asset("storage/imagesMinisterio/".$ministerio->foto)}}" alt="User Avatar"
    ...
    {{-- <div class="container border border-dark">
        <div class="row ">
                <div class="col-8 border border-dark">Lorem ipsum dolor sit amet, con beatae odit explicabo recusandae quas.</div>
                <div class="col-8 border border-dark">Lorem ipsum dolor sit amet, con beatae odit explicabo recusandae quas.</div>
                <div class="col-8 border border-dark">Lorem ipsum dolor sit amet, con beatae odit explicabo recusandae quas.</div>
                <div class="col-8 border border-dark">Lorem ipsum dolor sit amet, con beatae odit explicabo recusandae quas.</div>
            </div>
