            ...
            <form action="{{route("ministerios.update",$ministerio->id)}}" method="POST"  enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-lg-6 col-xl-4  mb-4">
                        ...
                        <input type="text" class="form-control" name="nombre" id="exampleInputNombre" value="{{$ministerio->nombre}}"  >
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="descripcion" id="editor" class="form-control" cols="30" rows="10"></textarea>
                            <script>
                                ClassicEditor
                    ...
                    <div class="row mb-4">
                        ...
                        <output id="list">
                            ...
                            @endif --}}
                            <img src="{{asset("storage/imagesMinisterio/".$ministerio->foto)}}" width="80%" alt="">
                        </output>
                        <script>
